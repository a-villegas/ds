...
/***************************************************************************
*   Searches for the number of iterations a key has in the list:
...
/*************************************************************************************************
*
*  Function creates a Node and initializes the data
*  @param _data:  Element data for a node list
*  @return: On success returns a struct node with its data field populated and next field = NULL
